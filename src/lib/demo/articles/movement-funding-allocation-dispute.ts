...
export const article: Article = {
  ...
  citationChecks: [
    { citationId: 'cit-funding-01', status: 'pass', reason: '汇总表 2 中三项构成比均可定位，核查另用报告附表的绝对金额重算，比例一致。', checkedAt: '2026-08-25T21:10:00Z' },
    { citationId: 'cit-funding-02', status: 'pass', reason: '方法与限制第 1 节为报告原文自述，核查逐句比对，正文表述未作强化。', checkedAt: '2026-08-25T21:12:00Z' },
    { citationId: 'cit-funding-03', status: 'pass', reason: '方法与限制第 3 节明确说明按金额加总的效果；核查用附表验证最大三笔资助占加总额的比重，与该说明一致。', checkedAt: '2026-08-25T21:15:00Z' },
    { citationId: 'cit-funding-04', status: 'pass', reason: '问卷全文、机构分布表与资助方名单三份附件均可下载并完整，核查确认非摘要版本。', checkedAt: '2026-08-25T21:18:00Z' },
    { citationId: 'cit-funding-05', status: 'pass', reason: '发现第 2 节载有类目适配的编码与三段田野记录摘录，核查确认正文表述未超出该节结论范围。', checkedAt: '2026-08-25T21:23:00Z' },
    { citationId: 'cit-funding-06', status: 'pass', reason: '样本与限制章节原文载明四个辖区六家组织与不追求代表性的声明。', checkedAt: '2026-08-25T21:24:00Z' },
    { citationId: 'cit-funding-07', status: 'pass', reason: '方法章节公开田野时长、编码簿与研究者立场声明；核查确认编码簿为可下载附件。', checkedAt: '2026-08-25T21:26:00Z' },
    { citationId: 'cit-funding-08', status: 'warn', reason: '议程 3 的表决结果与「记名表决」字样可定位；但会议记录只给出通过与否及总票数，未逐项列出赞成与反对的分项票数，因此正文只写「票数记录在案」，未给出具体比数。', checkedAt: '2026-08-25T21:31:00Z' },
    { citationId: 'cit-funding-09', status: 'pass', reason: '秘书处说明原文载明记录经摘要处理，核查确认原始发言稿未随记录公布。', checkedAt: '2026-08-25T21:33:00Z' },
    { citationId: 'cit-funding-10', status: 'pass', reason: '名册说明第 1 节载明登记与代表资格、法定咨询程序的连接关系。', checkedAt: '2026-08-25T21:36:00Z' },
    { citationId: 'cit-funding-11', status: 'pass', reason: '核查比对名册两个季度版本，确认拒绝登记理由随版本公布且增减可追溯。', checkedAt: '2026-08-25T21:38:00Z' },
    { citationId: 'cit-funding-12', status: 'pass', reason: '公开信正文与 47 家署名机构名单均可定位，核查逐条确认署名机构的联系方式字段完整。', checkedAt: '2026-08-25T21:42:00Z' },
    { citationId: 'cit-funding-13', status: 'pass', reason: '核查逐段检视公开信第 4 至 6 段，确认三处涉及资金分配的指控均无脚注、附件或引用来源。', checkedAt: '2026-08-25T21:45:00Z' },
    { citationId: 'cit-funding-14', status: 'warn', reason: '报道正文与被批评方的回应段落均可定位；但影印件仅以低分辨率图片发布，核查的文本提取失败，无法比对报道所引段落与影印件内容是否一致。', checkedAt: '2026-08-25T21:50:00Z' },
    { citationId: 'cit-funding-15', status: 'fail', reason: '核查无法验证两份纪要影印件的真实性：通讯社未做鉴定、未公布获取途径，图片无可提取文本，签署方也未公开确认。正文因此只把该来源用于「存在此类指控」，不用于指控内容本身。', checkedAt: '2026-08-25T21:53:00Z' },
    { citationId: 'cit-funding-16', status: 'pass', reason: '来函全文栏中双方文本均完整刊出，核查确认非节选。', checkedAt: '2026-08-25T21:57:00Z' },
    { citationId: 'cit-funding-17', status: 'pass', reason: '编辑部说明中载明人员规模与未作独立核对，为该媒体自述。', checkedAt: '2026-08-25T21:58:00Z' },
    { citationId: 'cit-funding-18', status: 'pass', reason: '航次记录与经费审计意见两份附件均可下载，核查确认审计意见由外部事务所出具。', checkedAt: '2026-08-25T22:02:00Z' },
    { citationId: 'cit-funding-19', status: 'pass', reason: '数据范围说明原文限定为该网络自身参与的救援。', checkedAt: '2026-08-25T22:03:00Z' },
    { citationId: 'cit-funding-20', status: 'pass', reason: '计数规则、资金来源与利益冲突声明三项均在报告前言中，核查逐项确认。', checkedAt: '2026-08-25T22:06:00Z' },
    { citationId: 'cit-funding-21', status: 'pass', reason: '限制说明原文载明数字仅代表求助人群，与正文表述一致。', checkedAt: '2026-08-25T22:07:00Z' },
    { citationId: 'cit-funding-22', status: 'pass', reason: '经费来源、个案计数规则与翻译流程三项均可在报告说明部分定位。', checkedAt: '2026-08-25T22:10:00Z' },
    { citationId: 'cit-funding-23', status: 'pass', reason: '方法与限制章节原文载明样本仅限主动求助者。', checkedAt: '2026-08-25T22:11:00Z' },
    { citationId: 'cit-funding-24', status: 'pass', reason: '通讯第 1 页可逐字定位该表述；核查记录该来源带 caution 标记，正文已写明其为竞选材料。', checkedAt: '2026-08-26T09:20:00Z' },
    { citationId: 'cit-funding-25', status: 'pass', reason: '核查尝试为通讯所引三项统计定位出处，三项均无注明；其中一项与自治区公布的统计定义不一致，差异可在自治区公开定义文件中直接比对。', checkedAt: '2026-08-26T09:26:00Z' },
    { citationId: 'cit-funding-26', status: 'pass', reason: '样本说明位于报告首页，滚雪球招募、两座城市与不可推及全国三点均为机构自述。', checkedAt: '2026-08-26T09:31:00Z' },
    { citationId: 'cit-funding-27', status: 'warn', reason: '问卷原文、回收率与未回复名单均可定位；但「未回复者可能等待更久」在原报告中是作者提出的推测而非发现，正文已按推测处理，核查仍标记以防后续引用时被升格。', checkedAt: '2026-08-26T09:35:00Z' },
    { citationId: 'cit-funding-28', status: 'fail', reason: '这是一项「不存在」形式的主张，自动核查无法正向验证：核查确认问卷全文题项清单中没有申请成功率与评分相关题项，但无法排除该观察站以问卷之外的方式采集过这些数据，也无法证明资助方从未在别处公布评分表。正文已据此改写为「问卷全文中不含相关题项」与「本站未取得」，不写「该数据不存在」。', checkedAt: '2026-08-26T09:41:00Z' },
  ],
