...
export const article: Article = {
  ...
  citationChecks: [
    ...
    { citationId: 'cit-norhold-09', status: 'missing', reason: '核查在 2026 年汇总的沿革说明中定位到 4,102 这一转述，但该文件不含 2023 年原始汇总的表格或链接，无法回到一手记录核对。正文与时间线已据此标注为单一来源报道。', checkedAt: '2026-08-27T22:31:00Z' },
    ...
    { citationId: 'cit-norhold-21', status: 'missing', reason: '自动核查尝试用监察署公开的逐家原始申报值复现该声明附表中的两个百分比，四种常见加权方式均无法得到相近结果；声明本身不含计算过程，核查判定为无法验证。正文与核查记录已据此改写。', checkedAt: '2026-08-29T09:07:00Z' },
