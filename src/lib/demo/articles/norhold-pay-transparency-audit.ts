...
export const article: Article = {
  ...
  citationChecks: [
    { citationId: 'cit-norhold-01', status: 'found', reason: '自动核查在申报汇总表 1 中定位到四个数值（4,812 / 4,357 / 379 / 76）与迟报名单链接，四项全部一致。', checkedAt: '2026-08-27T22:14:00Z' },
    { citationId: 'cit-norhold-02', status: 'found', reason: '合计中位差距 11.4% 在汇总表 3 中可直接读到，并与逐家原始值重新加权计算的结果一致（差异小于 0.05 个百分点）。', checkedAt: '2026-08-27T22:15:00Z' },
    { citationId: 'cit-norhold-03', status: 'found', reason: '核查抽取了 40 家雇主的逐家申报值并重算合计，确认「可被外部复算」这一表述成立。', checkedAt: '2026-08-27T22:18:00Z' },
    { citationId: 'cit-norhold-04', status: 'found', reason: '适用范围说明中「非正规就业不在申报范围」为文件原文表述，核查已定位到具体段落。', checkedAt: '2026-08-27T22:20:00Z' },
    { citationId: 'cit-norhold-05', status: 'found', reason: '沿革说明第 2 段载明 2024 年 1 月的申报表修订与纳入项目，日期与内容均一致。', checkedAt: '2026-08-27T22:21:00Z' },
    { citationId: 'cit-norhold-06', status: 'found', reason: '附录 B 的双口径回算表中四个数值全部定位到，且 14.1→12.6 与 13.2→11.4 两条序列的差值与正文表述一致。', checkedAt: '2026-08-29T14:40:00Z' },
    { citationId: 'cit-norhold-07', status: 'found', reason: '汇总表 6 载明行动计划字段填报率 62%；核查另确认文件中没有任何关于计划执行评估的规定。', checkedAt: '2026-08-27T22:25:00Z' },
    { citationId: 'cit-norhold-08', status: 'partial', reason: '「不做同岗位匹配」与「不按族裔、移民身份、残障状况分列」两点均可在指标定义中核实；但「不按雇佣形式分列」一项是核查从申报表字段清单中反推的结论，文件未作明文说明。', checkedAt: '2026-08-27T22:28:00Z' },
    { citationId: 'cit-norhold-09', status: 'missing', reason: '核查在 2026 年汇总的沿革说明中定位到 4,102 这一转述，但该文件不含 2023 年原始汇总的表格或链接，无法回到一手记录核对。正文与时间线已据此标注为单一来源报道。', checkedAt: '2026-08-27T22:31:00Z', acknowledged: true, acknowledgedNote: '相关陈述已改为归因表述：无法复现的两个百分比不再作为事实陈述，2023 年汇总值在正文与时间线中标注为转述。', acknowledgedBy: '主编（你）' },
    { citationId: 'cit-norhold-10', status: 'partial', reason: '38% 由本站以覆盖雇员数除以受雇人口口径得出，两个分项数值均可在文件中定位，但比值本身未出现在任何来源中；自动核查只能验证分子分母，不能验证该比值的口径一致性。', checkedAt: '2026-08-27T22:34:00Z' },
    { citationId: 'cit-norhold-11', status: 'found', reason: '面板表 2 中北屿的 11.4% 与排序位置均可定位，且与监察署申报汇总的合计值一致。', checkedAt: '2026-08-27T22:37:00Z' },
    { citationId: 'cit-norhold-12', status: 'found', reason: '方法说明第 2 段原文载明换算规则公开与自报行政数据两点。', checkedAt: '2026-08-27T22:38:00Z' },
    { citationId: 'cit-norhold-13', status: 'found', reason: '方法说明第 4 段明确覆盖范围为「有正式雇佣合同的全职岗位」，与图表的 limitation 字段表述一致。', checkedAt: '2026-08-27T22:39:00Z' },
    { citationId: 'cit-norhold-14', status: 'found', reason: '审计署结论第 5 节载明合规率与结构调整之间的落差，核查已比对原文与译文两个版本。', checkedAt: '2026-08-27T22:44:00Z' },
    { citationId: 'cit-norhold-15', status: 'found', reason: '报告附件包含被审计单位反驳意见全文，核查确认其为完整文本而非摘要。', checkedAt: '2026-08-27T22:45:00Z' },
    { citationId: 'cit-norhold-16', status: 'partial', reason: '综述确实报告了照护时间与劳动力市场参与的关联，但正文使用的「稳定关联」一语在原文中对应的是「多数纳入研究中方向一致」；核查提示不要把它读作效应量的陈述。', checkedAt: '2026-08-27T22:49:00Z' },
    { citationId: 'cit-norhold-17', status: 'found', reason: '局限说明段落中明确写有纳入研究的辖区偏向与外推限制。', checkedAt: '2026-08-27T22:50:00Z' },
    { citationId: 'cit-norhold-18', status: 'found', reason: '判决理由第 4 节载明法院采信薪酬回归分析并公开推论依据。', checkedAt: '2026-08-27T22:54:00Z' },
    { citationId: 'cit-norhold-19', status: 'partial', reason: '判决要求提供同职级同资历比较对象一点可以定位；但「机构整体差距不足以支撑歧视认定」是核查对判决理由第 6 节的概括，判决原文使用的是较窄的表述，只针对本案证据结构。', checkedAt: '2026-08-27T22:56:00Z' },
    { citationId: 'cit-norhold-20', status: 'found', reason: '声明第 2 段的表述可逐字定位；核查同时记录该来源为党派材料，正文已并列监察署原始值。', checkedAt: '2026-08-29T09:02:00Z' },
    { citationId: 'cit-norhold-21', status: 'missing', reason: '自动核查尝试用监察署公开的逐家原始申报值复现该声明附表中的两个百分比，四种常见加权方式均无法得到相近结果；声明本身不含计算过程，核查判定为无法验证。正文与核查记录已据此改写。', checkedAt: '2026-08-29T09:07:00Z', acknowledged: true, acknowledgedNote: '相关陈述已改为归因表述：无法复现的两个百分比不再作为事实陈述，2023 年汇总值在正文与时间线中标注为转述。', acknowledgedBy: '主编（你）' },
    { citationId: 'cit-norhold-22', status: 'found', reason: '名册说明第 1 节载明登记与法定咨询程序之间的连接关系。', checkedAt: '2026-08-27T23:02:00Z' },
    { citationId: 'cit-norhold-23', status: 'found', reason: '核查比对了名册的两个季度版本，确认拒绝登记理由随版本公布且增减可追溯。', checkedAt: '2026-08-27T23:04:00Z' },
    { citationId: 'cit-norhold-24', status: 'partial', reason: '「雇主规模普遍在门槛以下」可在个案分类第 2 节中读到，但该报告未公布各类个案的具体家数，核查无法核实「普遍」对应的比例。', checkedAt: '2026-08-27T23:09:00Z' },
    { citationId: 'cit-norhold-25', status: 'found', reason: '方法与限制章节原文载明样本仅限主动求助者，表述与正文一致。', checkedAt: '2026-08-27T23:10:00Z' },
    { citationId: 'cit-norhold-26', status: 'found', reason: '会议记录议程 4 载有记名表决结果与票数，核查确认决议文本包含下调门槛的要求。', checkedAt: '2026-08-27T23:14:00Z' },
    { citationId: 'cit-norhold-27', status: 'partial', reason: '相关论述分布在讨论章节的三处，核查无法定位到单一段落；且该研究覆盖四个辖区六家组织、作者声明不追求代表性，正文已按「解释框架候选」而非证据使用。', checkedAt: '2026-08-27T23:18:00Z' },
    { citationId: 'cit-norhold-28', status: 'found', reason: '秘书处说明中载明记录经摘要处理，核查确认原始发言稿未随记录公布。', checkedAt: '2026-08-27T23:19:00Z' },
  ],
