...
export const article: Article = {
      ...
      blocks: [
        {
          ...
          type: 'paragraph',
          text:
            '本文核查了两条正在流传的说法，方向相反。第一条断言远程处方合法，第二条断言远程处方已经解决了可及性问题——后者与本站的价值立场更接近，但它的证据同样不够，本站没有因此放宽标准。两条核查的完整推理与「什么样的新证据会改变结论」都记录在核查卡片中。',
        },
        {
          id: 'blk-selva-21',
          type: 'list',
          items: [
            '「在塞尔瓦，通过远程问诊获得终止妊娠药物是合法的」——证据存在冲突。三个主管机关的读法互斥，均无公开解释文本，且至今没有任何司法解释可以援引[[c:cit-selva-01]][[c:cit-selva-03]]。',
            '「远程处方已经抹平了偏远地区与首都圈的可及性差距」——缺乏足够证据。现有可及性统计测量的是到实体机构的距离，不测量远程服务的使用；唯一相关的初步分析是一份未经评审的预印本[[c:cit-selva-07]][[c:cit-selva-15]]。',
          ],
        },
      ],
    },
  ...
  factCheckIds: ['fc-selva-01', 'fc-selva-02'],
  ...
  citationChecks: [
    { citationId: 'cit-selva-01', status: 'warn', reason: '核查在意见 § 44–47 中定位到三种读法的完整转述，内容与正文一致；但核查未能取得被转述的缔约国报告本身，也未能取得任何一部法律的原文，因此只能验证「意见如此记载」，不能验证「条文如此规定」。', checkedAt: '2026-08-19T20:12:00Z' },
    { citationId: 'cit-selva-02', status: 'pass', reason: '核查抽查了意见中 12 处标注，全部可回溯到编号索引，确认逐段标注属实。', checkedAt: '2026-08-19T20:15:00Z' },
    { citationId: 'cit-selva-03', status: 'pass', reason: '§ 51 原文载明被审查期间无以远程处方为由的刑事追诉；核查另确认意见附件中的案件清单亦无相关条目。', checkedAt: '2026-08-19T20:18:00Z' },
    { citationId: 'cit-selva-04', status: 'pass', reason: '§ 53–55 载有该项认定与延迟个案的记录编号，核查确认编号在材料索引中存在。', checkedAt: '2026-08-19T20:21:00Z' },
    { citationId: 'cit-selva-05', status: 'pass', reason: '机构名录附件可直接下载，核查确认其为逐机构列表而非汇总表。', checkedAt: '2026-08-19T20:26:00Z' },
    { citationId: 'cit-selva-06', status: 'pass', reason: '核查用公开的距离脚本对两个行政区重算中位值，结果与发布值一致（差异小于 0.3 公里）。', checkedAt: '2026-08-19T20:31:00Z' },
    { citationId: 'cit-selva-07', status: 'pass', reason: '口径说明第 2 节逐项列出未纳入的因素，与正文与图注的表述一一对应。', checkedAt: '2026-08-19T20:33:00Z' },
    { citationId: 'cit-selva-08', status: 'pass', reason: '结果第 3 节载有该关联的估计值与区间；核查确认正文未引用效应量，只陈述关联存在。', checkedAt: '2026-08-19T20:38:00Z' },
    { citationId: 'cit-selva-09', status: 'pass', reason: '方法章节的暴露定义明确为授权延迟，核查确认全文未出现远程问诊相关变量。', checkedAt: '2026-08-19T20:40:00Z' },
    { citationId: 'cit-selva-10', status: 'pass', reason: '判决理由第 3 节可逐句定位，译文与原文两版比对一致。', checkedAt: '2026-08-19T20:45:00Z' },
    { citationId: 'cit-selva-11', status: 'pass', reason: '判决附件确为下级法院查明事实清单，核查确认其与判决主文分列。', checkedAt: '2026-08-19T20:46:00Z' },
    { citationId: 'cit-selva-12', status: 'warn', reason: '刑事条款与修订沿革均可定位；但「无法判断条文与执行之间的差距」是核查依据公报体例作出的推断，公报本身没有这句自述。', checkedAt: '2026-08-19T20:51:00Z' },
    { citationId: 'cit-selva-13', status: 'pass', reason: '适用说明中明确指南规定的是应然流程，表述与正文一致。', checkedAt: '2026-08-19T20:54:00Z' },
    { citationId: 'cit-selva-14', status: 'warn', reason: '第一版的方法与数据链接均可定位；但该来源带有 caution 标记（未经评审的预印本），核查提示正文必须写明这一点——已确认正文写明。', checkedAt: '2026-08-19T20:58:00Z' },
    { citationId: 'cit-selva-15', status: 'fail', reason: '核查发现该预印本平台在 2026-08-24 上线了第二版，本站引用的第一版页面已被替换，正文所依据的表格在第二版中已改动；核查无法完成两版比对，也无法确认第一版的存档副本。正文与更新清单已据此标注。', checkedAt: '2026-08-26T07:40:00Z' },
    { citationId: 'cit-selva-16', status: 'fail', reason: '核查未能取得该报道所附排期表复印件的可读副本（仅有低分辨率图片）；且该报社此前一篇报道给出的延期次数与本篇不一致，核查无法判定哪一处有误。正文已改为「多次延期」，并只把该来源用于「同一份公开排期表存在」这一点。', checkedAt: '2026-08-26T07:44:00Z' },
    { citationId: 'cit-selva-17', status: 'pass', reason: '核查确认该报道中只出现一方的回应，且未出现联系另一方的说明。', checkedAt: '2026-08-19T21:02:00Z' },
    { citationId: 'cit-selva-18', status: 'pass', reason: '预先登记编号、问卷附件与 14% 拒答率均可在论文中定位。', checkedAt: '2026-08-19T21:06:00Z' },
    { citationId: 'cit-selva-19', status: 'pass', reason: '样本说明原文限定为到达急诊科并接受主动筛查的就诊者，与正文表述一致。', checkedAt: '2026-08-19T21:07:00Z' },
    { citationId: 'cit-selva-20', status: 'warn', reason: '庇护法庭公开裁决全文与编码手册一点可以核实；但「同一联邦体系内可比的公开标准」是本站的编辑类比，两个法庭是否受同一公开规则约束，核查无法确认。', checkedAt: '2026-08-19T21:12:00Z' },
    { citationId: 'cit-selva-21', status: 'pass', reason: '核查下载并运行了公开的距离脚本，确认可复算。', checkedAt: '2026-08-19T21:16:00Z' },
    { citationId: 'cit-selva-22', status: 'pass', reason: '数据可用性声明、评审意见与作者回应均随文公开，核查逐项确认。', checkedAt: '2026-08-19T21:18:00Z' },
    { citationId: 'cit-selva-23', status: 'pass', reason: '证据评级表与委员利益申报均在指南附件中，核查确认其为具名申报而非汇总声明。', checkedAt: '2026-08-19T21:21:00Z' },
  ],
  ...
  corrections: [
    {
      ...
      kind: 'correction',
      text: '本文初版依据海岸线报的报道写「庭审第三次延期」。本站随后发现该报社此前一篇报道对同一案件给出的延期次数为两次，未能核实两处差异的原因，也未取得排期表复印件的可读副本。已把正文改为「多次延期」，并在引用检查中把该条标记为核查失败。错误在于本站把单一二手报道中的具体计数当作已确认事实使用。',
      by: '事实核查编辑',
    },
    {
      id: 'cor-selva-02',
      ...
      kind: 'clarification',
      text: '本文初版把药品监管机构的读法概括为「禁止邮寄配送」。泛洲人权理事会意见所转述的缔约国报告用语是「须在登记机构内交付」，是否等同于禁止邮寄取决于该机构自身的解释，而这份解释未见公开文本。已改回原文用语，并在正文与分歧一节中说明这一区别。这是澄清而非更正：初版没有陈述错误事实，但把一个未经解释的法律用语替换成了一个更强的表述。',
      by: '值班主编（生育权议题）',
    },
    {
      id: 'cor-selva-03',
      ...
      kind: 'update',
      text: '更新待办：本文发布六天后，港区法院同一案件的公开排期表状态由「待审」变为「已裁判」。本站截至目前未取得裁决全文，也没有任何一手记录，因此不在正文中陈述裁决内容、不推测其走向，也不修改正文中「至今没有任何一份可引用的司法解释」等表述——而是把整篇标记为「需更新」，并在「后续值得关注的进展」一节逐条列出取得全文后需要核对的五点，同时点名受影响的三处具体表述。更新完成前，本文第一节末段、第二节末段与第五节的评级前提应被视为可能已经过时。另需在同一次更新中完成预印本第一版与第二版的比对。',
      by: '值班主编（生育权议题）· 法律复核会签',
    },
  ],
  ...
  provenance:
    '自动编辑台完成多语搜集、距离脚本复算、意见文件的逐段索引核对与引用初检，并在发布后的每日监测中捕捉到公开排期表的状态变更；人类编辑删去了初稿中依据二手转述描述裁决走向的两段、把药品监管机构读法改回原文用语、签署三条更正与更新记录，并作出维持「需更新」而非静默补写的决定。',
  featured: false,
  demo: true,
}
...
export const factChecks: FactCheck[] = [
  {
    id: 'fc-selva-01',
    articleId: 'art-selva',
    claim: '在塞尔瓦，通过远程问诊获得终止妊娠药物是合法的。',
    claimOrigin: '2026 年上半年起在跨境健康互助社群与若干服务导引页面中流传，通常以「远程医疗条例已经涵盖」为依据，不附条文编号。',
    spreadNote: '这条说法与它的反面（「远程处方一律违法」）在同一批社群中并行流传，两者都被当作确定信息转发。对读者的实际风险是双向的：误以为合法可能导致低估追诉风险，误以为违法则可能导致本可获得的照护被放弃。',
    verdict: 'conflicting-evidence',
    summary:
      '三个主管机关对同一行为给出三种互斥读法，没有任何一个机关公开发布过适用解释，也没有任何一份可援引的司法解释。现有证据不足以判定合法与否，这是法律状态本身的问题，不是取证不足。',
    reasoning: [
      '核实三种读法是否真实存在：泛洲人权理事会意见 § 44–47 转述缔约国自己的报告，载明卫生主管部门、药品监管机构与检察机关各自的主张[[c:cit-selva-01]]。',
      '核实是否有权威解释可援引：本站未取得任何一个机关公开发布的适用解释，也未取得三部法律的官方合订文本；全部描述都是国际机构对缔约国报告的转述[[c:cit-selva-02]]。',
      '核实是否有司法判定：同一份意见记载被审查期间没有以远程处方为由提起的刑事追诉[[c:cit-selva-03]]，因此检察机关的读法从未被裁判检验。',
      '判定为「证据存在冲突」而非「无法核实」：材料是可取得的、质量也相当，问题在于它们指向互斥的结论；这是规范层面的冲突，不是取证受阻。',
      '记录时效风险：本次核查完成后，港区法院同一案件的公开排期表状态变更为「已裁判」，本站尚未取得裁决全文。本结论在取得全文前保持不变，但已标注可能过时[[c:cit-selva-16]]。',
    ],
    citationIds: ['cit-selva-01', 'cit-selva-02', 'cit-selva-03', 'cit-selva-16'],
    whatWouldChangeIt:
      '任一主管机关公开发布具约束力的适用解释，或港区法院的裁决全文显示法院已就适用哪一部法律作出可超出个案的判断——两者之一出现，本结论将改判为「有充分证据支持」或「基本不实」中的一种，取决于其内容。三部法律的官方合订文本若能取得，也会使本站首次能够直接检验三种读法本身。',
  ...
  },
  {
    id: 'fc-selva-02',
    articleId: 'art-selva',
    claim: '远程处方已经抹平了偏远地区与首都圈的可及性差距。',
    claimOrigin: '出现在若干倡议材料与两场公开活动的介绍文字中，通常引用卫生统计司的距离统计作为「问题已被技术解决」的背景。',
    spreadNote: '这条说法的方向与本站的价值立场一致，也因此更容易被不加检验地转载。本站把它与方向相反的第一条放在同一标准下核查，理由写在下面第四步。',
    verdict: 'insufficient-evidence',
    summary:
      '现有的可及性统计测量的是到实体机构的距离，根本不测量远程服务的使用；唯一相关的初步分析是一份未经同行评审、且已出现未比对新版本的预印本。既没有证据支持这条说法，也没有证据否定它。',
    reasoning: [
      '检查数据能否回答这个问题：可及性统计以登记住址到在册机构的道路距离计算，口径中不含远程服务的使用量[[c:cit-selva-07]]；因此无论距离数字如何变化，都无法反映远程处方的效果。',
      '检查是否存在其他可用证据：唯一涉及相关主题的塞尔瓦本地研究是一份 2026 年 7 月的预印本，未经任何同行评审，且本站引用的第一版与随后上线的第二版存在未比对的表格改动[[c:cit-selva-14]][[c:cit-selva-15]]。',
      '检查是否可以借用其他研究：多点队列研究测量的是授权延迟而非远程问诊，其结论不能双向外推[[c:cit-selva-09]]。',
      '说明为何不下调标准：这条说法在政治方向上与本站的立场一致，但编辑政策要求对契合本站立场的说法适用同一证据门槛。判定为「缺乏足够证据」不等于该说法为假，也不等于远程处方无效——它意味着现有公开材料无法回答这个问题[[c:cit-selva-07]]。',
    ],
    citationIds: ['cit-selva-07', 'cit-selva-09', 'cit-selva-14', 'cit-selva-15'],
    whatWouldChangeIt:
      '卫生统计司在服务可及性统计中新增远程服务使用量口径，或该预印本完成同行评审且其修订后的结果仍支持可及性差距缩小——两者之一出现，本结论将重新评估。若出现按行政区分列的远程服务使用数据与实体服务使用数据的对照，本站可以第一次直接检验这条说法。',
    checkedAt: '2026-08-19',
    reviewedBy: '事实核查编辑 · 生育权议题编辑组复核',
  },
]
