...
export const article: Article = {
  ...
  sections: [
     ...
     * ---------------------------------------------------------------- */
    {
      id: 'sec-curriculum-factcheck',
      kind: 'factcheck',
      title: '事实核查',
      blocks: [
        {
          id: 'blk-curriculum-21',
          type: 'paragraph',
          text: '围绕这部法案流传最广的三种说法，都可以用立法公报刊出的条文原文直接核对。以下逐条给出结论与依据；完整的核查记录见本站事实核查页。',
        },
        {
          id: 'blk-curriculum-22',
          type: 'list',
          items: [
            '「第 12 条要求学校向低龄学生教授性行为细节。」——**基本不实**：条文中不存在此项要求，且相关内容在委员会阶段被推迟至更高学段[[c:cit-curriculum-04]][[c:cit-curriculum-07]]。',
            '「法案取消了家长的知情权。」——**具有误导性**：一般性退出权确实被否决，但事前查阅教材的权利在委员会阶段被写入第 17 条[[c:cit-curriculum-07]][[c:cit-curriculum-08]]。',
            '「泛洲人权理事会要求韦拉通过这部法案。」——**部分属实**：理事会 2025 年的意见建议纳入相关教育，但使用建议性措辞并保留辖区裁量权，未提及任何具体法案[[c:cit-curriculum-11]]。',
          ],
        },
      ],
    },
  ...
  factCheckIds: ['fc-curriculum-01', 'fc-curriculum-02', 'fc-curriculum-03'],
  ...
  citationChecks: [
    { citationId: 'cit-curriculum-01', status: 'pass', reason: '自动核查在立法公报刊出页定位到法案全文与 41 项修正提案编号，刊出日期与引用一致。', checkedAt: '2026-08-30T06:02:00Z' },
    { citationId: 'cit-curriculum-02', status: 'warn', reason: '「三条条文被要求逐条表决」在委员会报告的程序说明中可确认；但「逐条表决日程尚未公布」是核查时点的状态，无法由文件本身证明，正文已注明为二读开始时的情况。', checkedAt: '2026-08-30T06:04:00Z' },
    { citationId: 'cit-curriculum-03', status: 'pass', reason: '第 3 条与附则二的授权条款逐字核对一致，两年期限在附则二中明载。', checkedAt: '2026-08-30T06:05:00Z' },
    { citationId: 'cit-curriculum-04', status: 'pass', reason: '第 12 条六类内容逐项核对一致；核查另行确认全条文中不含「性行为」相关表述，这一否定性结论已通过全文检索验证。', checkedAt: '2026-08-30T06:07:00Z' },
    { citationId: 'cit-curriculum-05', status: 'pass', reason: '六个数值（29/38/47/55/61/74）在覆盖率表 1 中可直接读到；数据说明中确认为学校自报且未经督导核实。', checkedAt: '2026-08-30T06:09:00Z' },
    { citationId: 'cit-curriculum-06', status: 'pass', reason: '41 项提案、12 项采纳与 23 位发言人的构成在报告正文与听证名单中均可核对。', checkedAt: '2026-08-30T06:11:00Z' },
    { citationId: 'cit-curriculum-07', status: 'pass', reason: '附件三的三个版本对照可确认「多元家庭形态」的学段变更与罚则删除；第 17 条查阅权的新增在表决记录中可查。', checkedAt: '2026-08-30T06:13:00Z' },
    { citationId: 'cit-curriculum-08', status: 'pass', reason: '提案 17–25 共 9 项，表决记录显示全部否决，与引用一致。', checkedAt: '2026-08-30T06:14:00Z' },
    { citationId: 'cit-curriculum-09', status: 'pass', reason: '判决主文的适用范围仅及民事登记要件，核查确认全文未出现课程或教育相关条款。', checkedAt: '2026-08-30T06:16:00Z' },
    { citationId: 'cit-curriculum-10', status: 'warn', reason: '声明原文可访问且引述内容一致；但「三处引述与条文不符」是本站逐条比对的结果，属编辑判断而非文件自身陈述，正文已按此表述。发布方为利益相关方，该来源只用于证明主张存在。', checkedAt: '2026-08-30T06:18:00Z' },
    { citationId: 'cit-curriculum-11', status: 'pass', reason: '结论性意见 §44 的建议性措辞与辖区裁量保留条款逐句核对一致，全文未提及具体法案。', checkedAt: '2026-08-30T06:20:00Z' },
    { citationId: 'cit-curriculum-12', status: 'warn', reason: '58% 这一数值在问卷结果表 4 中可读到，抽样框与应答率亦公开；但发布方是法案支持方之一，且核查未能取得任何独立的师资准备程度数据用于对照。正文已说明该来源的立场与样本偏差方向。', checkedAt: '2026-08-30T06:22:00Z' },
    { citationId: 'cit-curriculum-13', status: 'pass', reason: '方法说明 §3 关于「必修」定义不一致与绝对数值不可比的表述逐句核对一致。', checkedAt: '2026-08-30T06:23:00Z' },
  ],
  ...
  provenance:
    '自动编辑台完成了跨语种搜集、重复报道合并、法案条文与委员会报告的回溯，并起草了全部九个章节与三项事实核查。主编复核了每一处引用与条文的对应关系，重写了「事件为何重要」一节以明确标注编辑判断，要求对法案支持方与反对方采用同一条证据标准，并批准排程。',
  demo: true,
}
...
export const factChecks: FactCheck[] = [
  {
    ...
    claim: '「第141号法案第 12 条要求学校向低龄学生教授性行为细节。」',
    claimOrigin: '2026 年 8 月 24 日韦拉家长团体联合会的联合声明，随后被三家评论站点转载。',
    spreadNote: '声明未附条号，转载时进一步简化为「法案要求向小学生教授性行为」。传播峰值出现在二读前两日。',
    verdict: 'mostly-false',
    summary: '法案第 12 条列举的六类内容中不存在此项要求，且全文检索确认条文中没有相关表述；委员会阶段还把最接近的一类内容推迟到了更高学段。',
    reasoning: [
      '立法公报刊出的第 12 条原文列举六类内容，逐项核对后没有任何一项涉及性行为细节的教学。',
      '对法案全文进行检索，未出现相关表述；这是一项否定性结论，已通过全文检索而非抽样阅读验证。',
      '委员会附件三显示，六类内容中最接近该说法的「多元家庭形态」在委员会阶段被从小学中段推迟到小学高段——修正方向与该说法相反。',
      '联合声明本身未附条号，其对第 12 条的三处引述与条文原文不一致，因此不能作为条文内容的依据。',
    ],
    citationIds: ['cit-curriculum-04', 'cit-curriculum-07', 'cit-curriculum-10'],
    whatWouldChangeIt: '如果教育部在两年内公布的年龄分级大纲中出现此类内容，该说法可能对大纲成立——但仍不会对第 12 条条文成立。大纲公布后本站将重新核查。',
  ...
  },
  {
    ...
    articleId: 'art-curriculum',
    claim: '「法案取消了家长的知情权。」',
    claimOrigin: '二读辩论中一位议员的发言，随后在社群转发中脱离语境流传。',
    spreadNote: '原发言的完整表述是「取消了家长的退出权」，转述过程中「退出权」被替换为「知情权」。',
    verdict: 'misleading',
    summary: '家长的一般性退出权确实被否决了 9 次，这部分属实；但事前查阅教材的权利在委员会阶段被写入第 17 条，因此「取消知情权」与条文相反。',
    reasoning: [
      '委员会表决记录显示，要求设立一般性退出权的 9 项修正提案全部被否决——就退出权而言，说法的事实基础成立。',
      '同一份报告显示，家长事前查阅教材的权利是委员会阶段被采纳的 12 项修正之一，写入第 17 条。',
      '把「退出权」表述为「知情权」，使读者得出与条文相反的结论：知情权不仅没有被取消，还是这一阶段新增的。',
      '本站将其判为具有误导性而非部分属实，因为所引事实本身可查证，问题出在替换关键词后的呈现方式。',
    ],
    citationIds: ['cit-curriculum-07', 'cit-curriculum-08'],
    whatWouldChangeIt: '如果第 17 条在逐条表决中被删除或修改，查阅权可能不再存在；届时该说法的判定需要重新评估。',
    checkedAt: '2026-08-30',
    reviewedBy: '主编（你）',
  },
  {
    id: 'fc-curriculum-03',
    articleId: 'art-curriculum',
    claim: '「泛洲人权理事会要求韦拉通过这部法案。」',
    claimOrigin: '法案支持方在二读前的一份宣传材料，同时被反对方引用为「外部干预」的证据。',
    spreadNote: '同一说法被辩论双方以相反目的使用，因此传播范围广于一般的单方面主张。',
    verdict: 'partly-true',
    summary: '理事会确实在 2025 年建议成员辖区将相关教育纳入义务教育，但使用的是建议性措辞、明确保留辖区裁量权，且从未提及任何具体法案。',
    reasoning: [
      '结论性意见 §44 的措辞为建议性，并在同段中保留了辖区对课程内容形式的决定权。',
      '意见全文未出现任何具体法案名称或编号，该意见作出时第141号法案尚未提交国会。',
      '「建议纳入相关教育」成立，「要求通过这部法案」不成立——说法中可拆分的两部分一真一假，因此判为部分属实。',
      '本站同时提示：该意见不具约束力，把它读作「国际机构的要求」在两个方向上都不准确。',
    ],
    citationIds: ['cit-curriculum-11'],
    whatWouldChangeIt: '如果理事会后续就韦拉作出点名的、针对具体立法的结论性意见，该说法的前半部分强度会上升；本站将跟进理事会下一轮审议。',
    checkedAt: '2026-08-30',
    reviewedBy: '主编（你）',
    history: [
      {
        at: '2026-08-29',
        verdict: 'mostly-false',
        note: '初判为基本不实，理由是理事会从未提及具体法案。复核时认为该判定忽略了说法中确实成立的部分（理事会的确建议纳入相关教育），标准过严，因此修订为部分属实并逐条拆分说明。修订理由公开保留。',
      },
    ],
  },
]
